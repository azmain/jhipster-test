...
import io.jh.test.IntegrationTest;
import io.jh.test.domain.Employee;
import io.jh.test.repository.EmployeeRepository;
import io.jh.test.repository.search.EmployeeSearchRepository;
...
class EmployeeResourceIT {
    ...
    void createEmployee() throws Exception {
        ...
        assertThat(testEmployee.getSlipNo()).isEqualTo(DEFAULT_SLIP_NO);
        assertThat(testEmployee.getPayOrderNumber()).isEqualTo(DEFAULT_PAY_ORDER_NUMBER);
    }
    ...
    void putExistingEmployee() throws Exception {
        ...
        assertThat(testEmployee.getSlipNo()).isEqualTo(UPDATED_SLIP_NO);
        assertThat(testEmployee.getPayOrderNumber()).isEqualTo(UPDATED_PAY_ORDER_NUMBER);
        await()
            .atMost(5, TimeUnit.SECONDS)
            .untilAsserted(() -> {
                int searchDatabaseSizeAfter = IterableUtil.sizeOf(employeeSearchRepository.findAll());
                ...
                assertThat(testEmployeeSearch.getSlipNo()).isEqualTo(UPDATED_SLIP_NO);
                assertThat(testEmployeeSearch.getPayOrderNumber()).isEqualTo(UPDATED_PAY_ORDER_NUMBER);
            });
    }
