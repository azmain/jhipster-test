...
describe('Employee e2e test', () => {
  ...
  describe('new Employee page', () => {
    ...
    it('should create an instance of Employee', () => {
      ...
      cy.get(`[data-cy="hireDate"]`).type('2023-11-04T13:09').blur().should('have.value', '2023-11-04T13:09');

      cy.get(`[data-cy="salary"]`).type('91292').should('have.value', '91292');

      cy.get(`[data-cy="commissionPct"]`).type('70377').should('have.value', '70377');

      cy.get(`[data-cy="slipNo"]`).type('85216').should('have.value', '85216');

      cy.get(`[data-cy="payOrderNumber"]`).type('48509').should('have.value', '48509');
