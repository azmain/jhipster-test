...
/**
 * REST controller for managing {@link io.jh.test.domain.Employee}.
 */
@RestController
@RequestMapping("/api")
@Transactional
    ...
    public ResponseEntity<Employee> partialUpdateEmployee(
        ...
        Optional<Employee> result = employeeRepository
            ...
            .map(existingEmployee -> {
                ...
                if (employee.getSlipNo() != null) {
                    existingEmployee.setSlipNo(employee.getSlipNo());
                }
                if (employee.getPayOrderNumber() != null) {
                    existingEmployee.setPayOrderNumber(employee.getPayOrderNumber());
                }
