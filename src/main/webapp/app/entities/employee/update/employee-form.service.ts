...
type EmployeeFormGroupContent = {
  ...
  slipNo: FormControl<EmployeeFormRawValue['slipNo']>;
  payOrderNumber: FormControl<EmployeeFormRawValue['payOrderNumber']>;
};
...
export class EmployeeFormService {
  createEmployeeFormGroup(employee: EmployeeFormGroupInput = { id: null }): EmployeeFormGroup {
    ...
    return new FormGroup<EmployeeFormGroupContent>({
      ...
      slipNo: new FormControl(employeeRawValue.slipNo),
      payOrderNumber: new FormControl(employeeRawValue.payOrderNumber),
    });
  }
